    ...
    <div className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1 md:py-4">
        <div className="flex items-center justify-between md:justify-start">
          ...
          <Link to="/products" className="font-bold text-gray-700 text-2xl">Shop.</Link>

          <div className="hidden md:flex space-x-3 flex-1 lg:ml-8">
            <Link className="px-2 py-2 hover:bg-gray-200 rounded-lg text-gray-400 hover:text-gray-600 focus:bg-gray-200 focus:text-black" to="/">Home</Link>
            <Link className="px-2 py-2 hover:bg-gray-200 rounded-lg text-gray-400 hover:text-gray-600 focus:bg-gray-200 focus:text-black" to="/products">Products</Link>
            <Link className="px-2 py-2 hover:bg-gray-200 rounded-lg text-gray-400 hover:text-gray-600 focus:bg-gray-200 focus:text-black" to="/paginated">Paginated</Link>
            <Link className="px-2 py-2 hover:bg-gray-200 rounded-lg text-gray-400 hover:text-gray-600 focus:bg-gray-200 focus:text-black" to="/parallel">Parallel</Link>
            <Link className="px-2 py-2 hover:bg-gray-200 rounded-lg text-gray-400 hover:text-gray-600 focus:bg-gray-200 focus:text-black" to="/optimistic">Optimistic</Link>
            <Link className="px-2 py-2 hover:bg-gray-200 rounded-lg text-gray-400 hover:text-gray-600 focus:bg-gray-200 focus:text-black" to="/InfiniteScrolling">Infinite Scrolling</Link>
          </div>
